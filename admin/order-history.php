...
<head>
    ...
    <title>Admin | Riwayar Order</title>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="order-history.php" class="nav-link active">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-hover text-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                $id = $_GET['No_Invoice'];
                                                $data = mysqli_query($koneksi, "SELECT * FROM Table_RiwayatOrder");
